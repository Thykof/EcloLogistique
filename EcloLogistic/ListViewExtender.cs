...
{
    /*
    * https://stackoverflow.com/a/4545340/5903242
    */
    ...
    /*
     * https://msdn.microsoft.com/fr-fr/library/system.windows.forms.listview.listviewitemsorter(v=vs.110).aspx
    */
    class ListViewItemComparer : IComparer
    {
		...
		/// <summary>
        /// Compare two element in the ListViewTODO
        /// <returns>
        /// 0 if x is equivalent to y, -1 if x is less than y, 1 is x is more than y
        /// </returns>
        /// </summary>
        ...
        
        {
            ...
            // Prevent index error
            if (item_y.SubItems.Count < col || item_x.SubItems.Count < col)
            {
                return -1; 
            }

            string s_item_x = item_x.SubItems[col].Text;
            string s_item_y = item_y.SubItems[col].Text;

            return Helpers.Compare(s_item_x, s_item_y);
        }
    }
}
